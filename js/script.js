...
const global = {
	...
	api: {
		apiKey: '37c64d6d4287831d6a6a5dae73496684',
...
// Display backdrop image for details page
...
async function search() {
	...
	if (global.search.term !== '' && global.search.term !== null) {
		...
		showAlert('Please enter movie to search');
	}
}
...
// Display slides of now playing movies
